...
public enum RoleSetError
{
    ...
    /// </summary>
    [DescriptionAttribute("Invalid or missing role ID.")]
    InvalidRoleSetId = 1,

    /// <summary>
    /// No role set exists with the given ID or Name.
    /// </summary>
    [DescriptionAttribute("The requested role does not exist.")]
    RoleSetDoesNotExist = 2,

    /// <summary>
    /// A role set with the given Name already exists.
    /// </summary>
    [DescriptionAttribute("A role with this name already exists.")]
    RoleSetAlreadyExists = 3,

    /// <summary>
    /// The name provided is invalid or not set.
    /// </summary>
    [DescriptionAttribute("Invalid or missing role name.")]
    InvalidRoleSetName = 4,

    /// <summary>
    /// The rank provided is invalid or not set.
    /// </summary>
    [DescriptionAttribute("Invalid or missing role rank.")]
